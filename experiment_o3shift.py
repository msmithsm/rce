...
# -*- coding: utf-8 -*-
"""
O3 vertical shift experiment (no factor readjustment)
Created on Tue Dec  6 13:24:00 2016
...
for i, fac in enumerate(o3fac):
    ...
    atms.o3 = np.interp(pprof/fac, pprof, o3prof)
...
figname = 'img/{}_{}_{}g{}_o3shift_{}_z.png'.format(
                 slvkind,atmprof, radmodel,fstag,o3label)
print("Writing figure: {}".format(figname))

picklename = 'ndout/{}_{}_{}g{}_o3shift_{}_z.npz'.format(
                 slvkind,atmprof, radmodel,fstag,o3label)
