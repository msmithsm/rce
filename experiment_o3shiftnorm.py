...
# -*- coding: utf-8 -*-
"""
o3 shift experiments, with normalization of total column

Created on Tue Dec  6 14:04:36 2016
...
for i, fac in enumerate(o3fac):
    print('Shift o3 by {:4f} '.format(fac))
    atms.o3 = np.interp(pprof/fac, pprof, o3prof)/fac
...
yls2 = (175,225)
xls = 0.25, 4
xtcks = np.linspace(0.25,4,7)

plt.clf()
plt.suptitle('Shifting O3 ({oprof}) {model}, {aprof}'.format(
...
figname = 'img/{}_{}_{}g{}_o3shiftnorm_{}_z.png'.format(
                 slvkind,atmprof, radmodel,fstag,o3label)
print("Writing figure: {}".format(figname))

picklename = 'ndout/{}_{}_{}g{}_o3shiftnorm_{}_z.npz'.format(
                 slvkind,atmprof, radmodel,fstag,o3label)
